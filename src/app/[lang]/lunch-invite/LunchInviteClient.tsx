  ...
  return (
    <div style={{ maxWidth: 700, margin: "40px auto", padding: 16, textAlign: "center" }}>
      ...
      <div style={{ marginTop: 10, fontWeight: 800 }}>
        {ar ? "تحت رعاية  ا د رئيس  الجامعه  يتشرف ا.د عميد كلية العلوم  بدعوتكم  للغداءيرجى ابراز الباركود للاستفادة من الدعوة." : "Please show this QR at the restaurant entrance."}
      </div>
